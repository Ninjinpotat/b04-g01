...
def convert_to_cartesian(angles, distances):
    ...
    for angle, distance in zip(angles, distances):
        # Fill in the code to convert the polar coordinates to cartesian coordinates
        # Hint, Pythagoras' theorem can be used to convert polar to cartesian coordinates
        cartesian_X = distance * math.sin(angle * VAL_PI / 180) 
        cartesian_Y = distance * math.cos(angle * VAL_PI / 180)
...
def plot_live_scan():
    ...
    try:
        while True:
            ...
            # Sleep briefly to allow for a smoother display and to prevent overwhelming the terminal with updates. 
